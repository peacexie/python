...
DROP TABLE IF EXISTS `crawl_data_ys`;
CREATE TABLE `crawl_data_ys` (
...
DROP TABLE IF EXISTS `crawl_rule_ys`;
CREATE TABLE `crawl_rule_ys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `crawl_rule_ys` (`id`, `city`, `name`, `url`, `slist`, `surl`, `stitle`, `detail`, `dpub`, `dfrom`, `catid`, `sfrom`, `suser`, `field`, `fop`, `fval`, `cfgs`, `status`, `debug`, `agent`) VALUES
(1024,  'dg', '(demo)dg市政府-政务公告', 'http://www.dg.gov.cn/cndg/notice/news.shtml',  '.lbkj li', 'a',  'a',  '#zoomcon,.xq', '.lan12:eq(1),PUBLISHTIME,publishtime', '.lan12:eq(0),#ly', '1014', '东莞政府门户网站', '房掌柜整理',  'dfrom',  'inc',  '东莞市人民政府办公室', 'tab_repd==阳光网=房掌柜@@<UCAPCONTENT>@@</UCAPCONTENT>', 1,  1,  0),
(1025,  'dg', '(demo)dg发改局-通知公告', 'http://dgdp.dg.gov.cn/007330029/0801/list2.shtml', '.list-right_title',  'a',  'a',  '#UCAP-CONTENT,.cen', 'PUBLISHTIME:eq(1),publishtime:eq(1)',  'PUBLISHTIME:eq(0),publishtime:eq(0)',  '1014', 'a默认来源',  'b默认作者',  'dfrom',  '', '东莞政府门户网站', 'tab_repd==阳光网=房掌柜@@<UCAPCONTENT>@@</UCAPCONTENT>', 1,  0,  0),
(1033,  'dg', '(demo)dg建设局-通知公告(?)',  'http://zjj.dg.gov.cn/business/htmlfiles/dgjsj/ptzgg/list.htm', 'INFO,info',  'InfoURL,infourl',  'Title,title',  '#zoom',  '', '', '1009', '', '', '', '', 'das,dsad', 'pre_url==http://zjj.dg.gov.cn/publicfiles/business/htmlfiles/\r\npre_list==<xml id=\"DocumentsDataSrc12\">(*)</xml>',  0,  1,  0),
...
(1037,  'dg', '(demo)dg自然资源局-通知公告', 'http://ggzy.dg.gov.cn/ggzy/website/WebPagesManagement/GovNews/list?fcGovtype=Notice&noticeType=1&KindIndex=0', '#old_data tr', 'a',  'a',  '.content', '.date',  '', '1009', '', '', '', '', '', 'tab_repd==阳光网=房掌柜@@<UCAPCONTENT>@@</UCAPCONTENT>', 1,  0,  0),
(1067,  'test', 'testit', 'https://www.ithome.com/blog/', '.ulcl li', 'a',  'a',  '.post_content',  '#pubtime_baidu', '#source_baidu a',  '1009', '', '', '', '', '', '', 0,  0,  0),
(1066,  'test', 'fzgtest',  'http://dg.fzg360.com/news/lists/catid/1009.html',  '.box_news',  'h3 a', 'h3 a', '.detailcon', '.author span:eq(1)', '.author span:eq(2) em',  '1009', '', '', '', '', '', '', 0,  0,  0);
